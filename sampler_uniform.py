...
# filename = "/home/lucas/Documents/PhD/darksirenpop/sampler_gauss_priors_withcat.h5"
...
######### UNIFORM PRIORS #########
filename = f"/home/lucas/Documents/PhD/generated_data/alt_origin_hyperparameters/sampler_uniform_priors_withcat_{LTHRESH_STRING}.h5"
backend = emcee.backends.HDFBackend(filename)
# reset if starting a new run
# backend.reset(nwalkers, ndim)
