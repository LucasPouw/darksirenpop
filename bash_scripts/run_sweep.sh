...
for rate in 'madau'; do
    ...
    for agn_prior_lum in '46.5' '45.5' '44.5'; do
        ...
        for catalog_lum_thresh in $agn_prior_lum 'inf'; do
            
            ~/Documents/PhD/.venv/bin/python darksirenpop/run.py \
                --label 'zleq3_final_kmax5_gwtc5_luminformed_smoothcorr_MF' \
                --rate_parameters '{"b": 2.6, "c": 3.2, "d": 6.2}' \
                ...
                --zmin 0.000001 \
                --zmax 10 \
                --outfile realdata_zleq3_final_kmax5_gwtc5_luminformed_smoothcorr_MF.json \
                --real_data True
        done
    done
done
